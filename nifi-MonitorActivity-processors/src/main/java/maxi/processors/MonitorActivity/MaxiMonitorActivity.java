 ...
 */
package maxi.processors.MonitorActivity;
...
@CapabilityDescription("Ожидает окончания загрузки")
...
public class MaxiMonitorActivity extends AbstractProcessor {
    ...
    private static AtomicBoolean wasActivated = new AtomicBoolean(false);;
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) {
        ...
        if (flowFiles.isEmpty()) {
            ...
            isInactive = inactive.get() || (now >= previousSuccessMillis + thresholdMillis);
